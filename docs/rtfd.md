...
By default, the [puppet-openssl](https://github.com/ULHPC/puppet-openssl) repository is bound to the [ulhpc-puppet-openssl](http://ulhpc-puppet-openssl.rtfd.org) project on Read the Docs (to avoid confusion with other openssl projects). 
